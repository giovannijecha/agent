...
test("binds the dormant durable credential boundary", () => {
  ...
  for (const marker of [
    ...
    /No approved runtime filesystem binding may be named, aliased, or default-/u,
  ...
  for (const [file, marker] of [
    ...
    ["docs/ENGINEERING.md", "approved runtime filesystem binding"],
    ["docs/MAINTENANCE.md", "### Dormant durable credential boundary"],
    ["docs/MAINTENANCE.md", "exact current-path requirements"],
    ["docs/MAINTENANCE.md", "Do not re-export an approved runtime filesystem binding"],
