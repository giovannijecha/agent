import { spawn, type ReadOnlyChildProcess } from "node:child_process";
...
const RESOLVER_TIMEOUT_MILLISECONDS = 5_000;
...
export function resolvePlatformWorkspaceRoots(
  ...
  try {
    child = spawn(resolverPath(platform, architecture), EMPTY_ARGUMENTS, {
      cwd: packageRoot(),
