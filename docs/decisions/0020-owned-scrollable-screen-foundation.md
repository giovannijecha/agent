...
decision 0023 adds the bounded owned Markdown subset. Later decisions may add
CLI-owned transcript blocks, keyboard navigation, and responsive status
composition. Each capability must
