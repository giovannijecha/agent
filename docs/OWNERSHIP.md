...
| 2026-08-08 | [Kimi Code overview](https://www.kimi.com/code/docs/en/), [device login](https://www.kimi.com/code/docs/en/kimi-code-cli/reference/kimi-command.html), and [feedback routes](https://www.kimi.com/code/docs/en/kimi-code/contact-and-feedback.html) | CLI device OAuth, subscriber API keys for third-party tools, truthful client-identity rule, official feedback channels | Direct OAuth remains specific to Kimi Code while third parties use keys; basis for a public independent-client registration request | None; no source, endpoint, client identity, credential, or protocol fixture reused |
