...
| 2026-08-19 | [Ollama chat API](https://docs.ollama.com/api/chat), [tool calling](https://docs.ollama.com/capabilities/tool-calling), [streaming](https://docs.ollama.com/capabilities/streaming), and [Ollama OpenAPI](https://github.com/ollama/ollama/blob/main/docs/openapi.yaml) | Optional native tool-call contribution, object argument shape, function type and index history fields, and line-delimited streamed message records | Independently implemented model-neutral native normalization, canonical settled history, and content-free protocol phases under decision 0082 | None; no SDK, CLI, executable, local daemon, source, sample, fixture, prompt, response, model identifier, product identity, or implementation structure reused |
| 2026-08-19 | [Ollama API errors](https://docs.ollama.com/api/errors) | Public HTTP status-code semantics and JSON error-envelope shape for failed requests | Content-free classification of non-success HTTP outcomes into the closed provider failure families under decision 0080; response bodies remain unread | None; no SDK, CLI, executable, local daemon, source, sample, response, fixture, identifier, or implementation structure reused |
| 2026-08-19 | [Ollama client stream lifecycle at `a5165c5`](https://github.com/ollama/ollama/blob/a5165c53acc5206ce90a684900e0d90b6fb0cb26/api/client.go) and [API errors](https://github.com/ollama/ollama/blob/a5165c53acc5206ce90a684900e0d90b6fb0cb26/docs/api/errors.mdx) | The native client treats clean scanner exhaustion as successful stream completion after validated callbacks and propagates scanner and streamed error failures | Independently designed validated-contribution clean-end settlement and preserved transport-error separation under decision 0082 | None; no source, implementation structure, identifiers, tests, samples, responses, fixtures, or error text reused |
| 2026-08-19 | [Ollama chat API](https://docs.ollama.com/api/chat), [thinking capability](https://docs.ollama.com/capabilities/thinking), [tool calling](https://docs.ollama.com/capabilities/tool-calling), and [streaming](https://docs.ollama.com/capabilities/streaming) | Native request control, separate streamed reasoning field, and reasoning continuity in assistant history | Independently specified the disabled-by-default, bounded, non-executable thinking-stream reservation under decision 0083 | None; no SDK, CLI, executable, source, sample, fixture, prompt, response, model identifier, product identity, or implementation structure reused |
